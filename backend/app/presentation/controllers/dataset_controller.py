...
class DatasetController:
    def __init__(self, create_uc: CreateDatasetRecordUseCase, list_uc: ListDatasetRecordsUseCase, manifest_uc: BuildDatasetManifestUseCase, quality_uc: CheckDatasetQualityUseCase) -> None:
